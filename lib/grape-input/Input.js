...
var _searchAdSearchAd = require('../search-ad/searchAd');

var _searchAdSearchAd2 = _interopRequireDefault(_searchAdSearchAd);
...
var Input = (function (_Component) {
  ...
  function Input(props) {
    ...
    this.searchAd = _searchAdSearchAd2['default'](function (text) {
      _this.setState({ placeholder: text });
    });
  }
  ...
  Input.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    var state = this.createState(nextProps);
  ...
  Input.prototype.renderBrowser = function renderBrowser(options) {
    ...
    var top = (window.innerHeight - _browserStyle2['default'].browser.height) / 2;

    if (browser === 'search') {
      return _react2['default'].createElement(
        _modalBrowserBrowser2['default'],
        null,
        _react2['default'].createElement(_searchBrowserBrowser2['default'], _extends({}, options, {
          top: top,
          data: data,
    ...
    if (browser === 'emoji') {
      return _react2['default'].createElement(
        _modalBrowserBrowser2['default'],
        null,
        _react2['default'].createElement(_emojiBrowserBrowser2['default'], _extends({}, options, {
          top: top,
  ...
  Input.prototype.createState = function createState(nextProps) {
    var state = _lodashObjectPick2['default'](nextProps, 'browser', 'data', 'isLoading', 'placeholder');
  ...
  Input.prototype.replaceQuery = function replaceQuery(replacement, options) {
    ...
    this.setState({ editableFocused: true }, function () {
      var replaced = _this3.editable.replaceQuery(replacement, options);
      callback(replaced);
    });
  };
  ...
  Input.prototype.insertQuery = function insertQuery(queryStr, options) {
    ...
    this.setState({ editableFocused: true }, function () {
      var inserted = _this4.editable.modifyAtCaret(function (left, right) {
        var newLeft = left;
        // Add space after text if there is no.
        if (newLeft[newLeft.length - 1] !== ' ') newLeft += ' ';
        newLeft += queryStr;
        return [newLeft, right];
      }, _extends({}, options, { query: _this4.query.toJSON() }));
      callback(inserted);
    });
  };
  ...
  Input.prototype.onAbort = function onAbort() {
    ...
    this.closeBrowser({ editableFocused: true }, function () {
      _this5.emit('abort', _extends({}, data, { browser: _this5.state.browser }));
    });
  };
  ...
  Input.prototype.onFocusEditable = function onFocusEditable() {
    ...
    this.setState({ editableFocused: true }, function () {
      if (!_this7.props.focused) _this7.emit('focus');
    });
  };
  ...
  Input.prototype.onBlurEditable = function onBlurEditable() {
    ...
    this.setState({ editableFocused: false }, function () {
      if (!utils.isBrowserType(_this8.state.browser)) {
        _this8.onBlurBrowser();
      }
      if (_this8.props.focused) _this8.emit('blur');
    });
  };
  ...
  Input.prototype.onChangeQuery = function onChangeQuery(newQueryStr) {
    ...
    this.replaceQuery(newQueryStr, options, function (replaced) {
      var open = function open(inserted) {
        if (inserted) _this10.setState({ browserOpened: true });
      };
      return replaced ? open(replaced) : _this10.insertQuery(newQueryStr, options, open);
    });
  };
